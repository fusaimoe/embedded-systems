...
public class C {
    ...
    static final String TARGET_BT_DEVICE_NAME = "Mordor";
    static final String TARGET_BT_DEVICE_UUID = "00001101-0000-1000-8000-00805F9B34FB";

    static final String ARDUINO_PRESENCE = "presence";
    static final String ARDUINO_ALARM = "a";
    static final String ARDUINO_ALARM_NOT = "n";
